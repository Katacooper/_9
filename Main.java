...
public class Main {
    ...
    private static void exercise3() {
        ...
        if(ourDouble > 2.5)
        {
            System.out.println("Greater than 2.5: " + ourDouble);
        }
        else if(ourDouble < 2.5)
            {
                System.out.println("It's less than 2.5 but let me adjust one thing...");
                ourDouble = ourDouble + 1.0;
                if (ourDouble < 2.5)
                {
                    System.out.println("Nope, still less than 2.5: " +ourDouble);
                }
                else
                {
                    System.out.println("Okay, now is greater than 2.5: " + ourDouble);
                }
            }
    }
    ...
    private static void exercise4() {
        ...
        if(employeeAge >= 65)
        {
            System.out.println("Retired: " + employeeAge);
        }
        else if(employeeAge >= 35 && employeeAge < 65)
        {
            System.out.println("Experienced Worker: " + employeeAge);
        }
        else if(employeeAge >= 18 && employeeAge < 35)
        {
            System.out.println("New Worker: " + employeeAge);
        }
        else
        {
            System.out.println("School age: " + employeeAge);
        }
    }
}
